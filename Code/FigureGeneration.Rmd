...
saveRDS(object = knitr::kable(DataWrangleTable), file = file.path("..", "OutPut", "DataWranglingTable.Rds"))
```
...
saveRDS(object = DiatomDataFlowChart, file = file.path("..", "Output", "DiatomDataFlowChart.Rds"))

# Create a PNG file
DiatomDataFlowChart %>%
export_svg() %>%
charToRaw %>%
rsvg_png(file = file.path("..", "Output", "DiatomDataFlowChart.png"))
```
...
saveRDS(object = MetaDataFullFlowChart, file = file.path("..", "Output", "MetaDataFullFlowChart.Rds"))

# Create a PNG file
MetaDataFullFlowChart %>%
export_svg() %>%
charToRaw %>%
rsvg_png(file = file.path("..", "Output", "MetaDataFullFlowChart.png"))
```
...
saveRDS(object = MetaDataSimpleFlowChart, file = file.path("..", "Output", "MetaDataSimpleFlowChart.Rds"))

# Create a PNG file
MetaDataSimpleFlowChart %>%
export_svg() %>%
charToRaw %>%
rsvg_png(file = file.path("..", "Output", "MetaDataSimpleFlowChart.png"))
```
